...
<p align="left">
  ...
  Developing embedded software for <strong>ARM-based processors and FPGAs</strong> using mainly C, frequently utilizing communication protocols such as <strong>UART and I2C</strong> and <strong>FreeRTOS</strong>.
  ⚙️ Focus Areas:<br>
